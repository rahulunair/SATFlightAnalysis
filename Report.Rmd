...
In this block, historical weather data is stored as weather_data_full dataframe. A new variable is created for weather_data_full, year. This is used to filter off data for year less than 2012.
